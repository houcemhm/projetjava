...
public class AddSalarieController implements Initializable {
	...
	public void addSalarie() {
		...
		entrepriseService ents = new entrepriseService();
		if (re.isSelected()) {
			employe emp = new employe(Integer.parseInt(tfMat.getText()), tfNom.getText(), tfEmail.getText(), "employe",
	...
	public void listerMinMax() {
		...
		List<salarie> listSalMinMax = sv.betweenSal(Double.parseDouble(tfSalaireMin.getText()),
